 ...
 *
 * The XDK links block-device drivers straight into the title (the
 * Memory Unit driver is the shipping example), so the kernel hands
 * title code real IRPs and the title reads them field by field:
